...
package com.navis.argo.webservice.types.v1_0;
...
public class ResponseType  implements java.io.Serializable {
    ...
    private com.navis.argo.webservice.types.v1_0.MessageType[] messageCollector;

    private com.navis.argo.webservice.types.v1_0.QueryResultType[] queryResults;
    ...
    public ResponseType(
           ...
           com.navis.argo.webservice.types.v1_0.MessageType[] messageCollector,
           com.navis.argo.webservice.types.v1_0.QueryResultType[] queryResults) {
           this.status = status;
     ...
     */
    public com.navis.argo.webservice.types.v1_0.MessageType[] getMessageCollector() {
        return messageCollector;
    }
     ...
     */
    public void setMessageCollector(com.navis.argo.webservice.types.v1_0.MessageType[] messageCollector) {
        this.messageCollector = messageCollector;
    }
     ...
     * @return queryResults
     */
    public com.navis.argo.webservice.types.v1_0.QueryResultType[] getQueryResults() {
        return queryResults;
    }
     ...
     * @param queryResults
     */
    public void setQueryResults(com.navis.argo.webservice.types.v1_0.QueryResultType[] queryResults) {
        this.queryResults = queryResults;
    }

    public com.navis.argo.webservice.types.v1_0.QueryResultType getQueryResults(int i) {
        return this.queryResults[i];
    }

    public void setQueryResults(int i, com.navis.argo.webservice.types.v1_0.QueryResultType _value) {
        ...
        _equals = true && 
            ...
            ((this.messageCollector==null && other.getMessageCollector()==null) || 
             (this.messageCollector!=null &&
              java.util.Arrays.equals(this.messageCollector, other.getMessageCollector()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMessageCollector() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMessageCollector());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMessageCollector(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://types.webservice.argo.navis.com/v1.0", "Messages"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
